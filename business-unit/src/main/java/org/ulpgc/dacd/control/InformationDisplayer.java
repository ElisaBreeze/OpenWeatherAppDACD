...
public class InformationDisplayer {
    ...
    private static void showAvailableHotels() throws StoreException {
        try {
            ...
            System.out.println("------------------------");
            System.out.println("Which hotel do you want to see information for? Enter the hotel name:");
    ...
    private static void showHotelInformation(String hotelName) throws StoreException {
        try {
            ...
            System.out.println("------------------------");
            System.out.println("Information about the chosen Hotel");
            while (resultSet.next()) {
    ...
    private static void showBestOptionInformation(String bestOption) throws StoreException {
        try {
            ...
            ResultSet resultSet = preparedStatement.executeQuery();
            System.out.println("------------------------");
            System.out.println("Information about the chosen Best Option");
            while (resultSet.next()) {
                System.out.println("Hotel Name: " + resultSet.getString("hotelName"));
                System.out.println("Price: " + resultSet.getDouble("price"));
                System.out.println("------------------------");
    ...
    private static void showWeatherPredictions(ResultSet resultSet) throws SQLException {
        System.out.println("Weather Predictions for the next 5 days:");
        System.out.println("------------------------");
        for (int i = 1; i <= 5; i++) {
            System.out.println("Day " + i);
            System.out.println("Temperature: " + resultSet.getDouble("day" + i + "_temperature"));
            System.out.println("Precipitation: " + resultSet.getDouble("day" + i + "_precipitation"));
            System.out.println("Clouds: " + resultSet.getDouble("day" + i + "_clouds"));
            System.out.println("------------------------");
        }
        System.out.println("------------------------");
    }
